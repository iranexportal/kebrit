...
> **نکته مهم برای مشتری‌ها**: اگر هدف شما یکپارچه‌سازی سامانه‌تان با Kebrit برای شروع/پایان آزمون دانشجو است،
> مستند اصلی شما **`docs/INTEGRATION_API.md`** است. این فایل بیشتر برای مدیریت داخلی کاربران/نقش‌ها (ادمین‌ها) کاربرد دارد.
